...
def main():
    ...
    loss_fn = DiceCELoss3D(num_classes=NUM_CLASSES, ce_weight=1.0, dice_weight=1.0)
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        print(
            "Sin mejora "
            f"val_loss: {epochs_without_val_loss_improvement}/{patience} | "
        ...
        if (
            epochs_without_val_loss_improvement >= patience
            or epochs_without_dice_improvement >= patience
        ):
